...
Например, накануне система мониторинга показала аномалию. Воспроизвести ситуацию вручную невозможно.
...
Результат: Нашли, что при потере пакетов обработчик, например, падает с KeyError.
